...
<head>
    ...
    <title>Schedule | My Beautyfill</title>
            ...
            <li class="nav-item mr-lg-3 ">
                ...
                <li class="nav-item dropdown mr-lg-3 ">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item py-3 active" href="/business/schedule.php">Schedule</a>
...
<div class="list-group sticky-top" aria-orientation="vertical" style="top: 125px;">
    ...
    <a class="list-group-item list-group-item-action active" href="/business/schedule.php">Schedule</a>
    ...
    <a class="list-group-item list-group-item-action " href="/business/subscription.php">Subscription</a>
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-lg-6">
                                    <div class="business-schedule-block">
                        <h2>Saturday</h2>
                            ...
                            <p>Business Hours: 6:00am - 9:00pm</p>Shift has not been set yet.
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class='mb-5'>No scheduled time off</p>                    </div><!-- end col -->
                </div><!-- end row -->
            </div><!-- end col -->
        </div><!-- end row -->
