...
<head>
    ...
    <title>Employees | My Beautyfill</title>
...
<nav class="navbar navbar-expand-lg sticky-top navbar-light">
                ...
                <li class="nav-item dropdown mr-lg-3 ">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item py-3 " href="/business/schedule.php">Schedule</a>
                                                    ...
                                                    <a class="dropdown-item py-3 active" href="/business/employees.php">Employees</a>
    ...
    <div class="container text-center py-3">
        <h1>Employees of MyBeautyFill Pro</h1>
    </div>
...
<div class="list-group sticky-top" aria-orientation="vertical" style="top: 125px;">
    ...
    <a class="list-group-item list-group-item-action " href="/business/schedule.php">Schedule</a>
            ...
            <a class="list-group-item list-group-item-action active" href="/business/employees.php">Employees</a>
    ...
    <a class="list-group-item list-group-item-action " href="/business/subscription.php">Subscription</a>
            ...
            <div class="col-md-9">
                ...
                <table class="table table-hover mb-5 animate-table">
                    <thead>
                    <tr>
                    ...
                    <tbody>
                            ...
                            <td class="align-middle">
                                Owner                            </td>
                            <td class="align-middle business-employees-action">
                                <i class="fal fa-calendar-alt business-employees-action-edit-schedule" data-id="36" data-uid="57" data-name="" data-toggle="tooltip" data-placement="bottom" title="Edit Schedule"></i>

                                <i class="fal fa-calendar-times business-employees-action-edit-breaks" data-id="36" data-uid="57" data-name="" data-toggle="tooltip" data-placement="bottom" title="Breaks"></i>

                                <i class="fal fa-island-tropical business-employees-action-edit-daysoff" data-id="36" data-uid="57" data-name="" data-toggle="tooltip" data-placement="bottom" title="Vacation Days"></i>
                                    ...
                                    <tr class="font-italic" style="opacity:0.5;">
                        <td class="align-middle">
                            ifundmybeautyfill@launch.com                        </td>
                        <td class="align-middle">
                            Pending                        </td>
                        <td class="align-middle business-employees-action">
                            <i class="fal fa-user-times business-employees-action-del-user" data-id="41" data-uid="<br />
<b>Notice</b>:  Undefined index: users_id in <b>/home/podoco/public_html/mybeautyfillbeta.app/business/employees.php</b> on line <b>548</b><br />
" data-toggle="tooltip" data-placement="bottom" title="Remove Employee"></i>
                            <!--<i class="fal fa-envelope" data-toggle="tooltip" data-placement="bottom" title="Resend Invite"></i>-->
                        </td>
                    </tr>
                                    <tr class="font-italic" style="opacity:0.5;">
                        <td class="align-middle">
                            testassistant@test.com                        </td>
                        <td class="align-middle">
                            Pending                        </td>
                        <td class="align-middle business-employees-action">
                            <i class="fal fa-user-times business-employees-action-del-user" data-id="40" data-uid="<br />
<b>Notice</b>:  Undefined index: users_id in <b>/home/podoco/public_html/mybeautyfillbeta.app/business/employees.php</b> on line <b>548</b><br />
" data-toggle="tooltip" data-placement="bottom" title="Remove Employee"></i>
                            <!--<i class="fal fa-envelope" data-toggle="tooltip" data-placement="bottom" title="Resend Invite"></i>-->
                        </td>
                                    ...
                                    <tr class="font-italic" style="opacity:0.5;">
                        <td class="align-middle">
                            testemployee@test.com                        </td>
                        <td class="align-middle">
                            Pending                        </td>
                        <td class="align-middle business-employees-action">
                            <i class="fal fa-user-times business-employees-action-del-user" data-id="37" data-uid="<br />
<b>Notice</b>:  Undefined index: users_id in <b>/home/podoco/public_html/mybeautyfillbeta.app/business/employees.php</b> on line <b>548</b><br />
" data-toggle="tooltip" data-placement="bottom" title="Remove Employee"></i>
                            <!--<i class="fal fa-envelope" data-toggle="tooltip" data-placement="bottom" title="Resend Invite"></i>-->
                        </td>
                ...
                <div class="text-center business-edit-services-save">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#business-add-new-employee">Add new employee</button>
                </div>
    ...
    <div class="modal fade" id="business-edit-employee-schedule" tabindex="-1" role="dialog" aria-labelledby="business-edit-employee-schedule-label" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="/business/employees.php" method="post">
                    <div class="modal-header">
                        <h5 class="modal-title" id="business-edit-employee-schedule-label">Edit <span></span>'s Schedule</h5>
                    ...
                    <div class="d-none">
                        <input text="number" name="business-edit-employee-schedule-id" value="" class="form-control">
                        <input text="number" name="business-edit-employee-schedule-uid" value="" class="form-control">
                        <input text="text" name="updateEmployeeSchedule" value="00020192600029831465846000" class="form-control">
    ...
    <div class="modal fade" id="business-edit-employee-breaks" tabindex="-1" role="dialog" aria-labelledby="business-edit-employee-breaks-label" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="/business/employees.php" method="post">
                    <div class="modal-header">
                        <h5 class="modal-title" id="business-edit-employee-breaks-label">Edit <span></span>'s Breaks</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="d-none">
                        <input text="number" name="business-edit-employee-breaks-id" value="" class="form-control">
                        <input text="number" name="business-edit-employee-breaks-uid" value="" class="form-control">
                        <input text="text" name="updateEmployeebreaks" value="00020192600029831465846000" class="form-control">
    ...
    <div class="modal fade" id="business-edit-employee-daysoff" tabindex="-1" role="dialog" aria-labelledby="business-edit-employee-daysoff-label" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="/business/employees.php" method="post">
                    <div class="modal-header">
                        <h5 class="modal-title" id="business-edit-employee-daysoff-label">Edit <span></span>'s Days Off</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="d-none">
                        <input text="number" name="business-edit-employee-daysoff-id" value="" class="form-control">
                        <input text="number" name="business-edit-employee-daysoff-uid" value="" class="form-control">
                        <input text="text" name="updateEmployeeDaysOff" value="00020192600029831465846000" class="form-control">
    ...
    <div class="modal fade" id="business-add-new-employee" tabindex="-1" role="dialog" aria-labelledby="business-add-new-employee-label" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="/business/employees.php" method="post">
                    <div class="modal-header">
                        <h5 class="modal-title" id="business-add-new-employee-label">Add New Employee</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="biz-invite-employee">Enter email:</label>
                            <input type="email" id="biz-invite-employee" name="biz-invite-employee" class="form-control" required>
                        </div>
                    </div>
