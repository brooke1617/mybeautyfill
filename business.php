...
<nav class="navbar navbar-expand-lg sticky-top navbar-light">
    ...
    <div class="homepage-intro-container mb-5">
        <div class="homepage-intro d-flex align-items-center justify-content-center homepage-intro-biz business-homepage">
            <div class="homepage-intro-user-content text-center">
                <h1>Are you a Beauty Professional or Indie Beauty Brand?</h1>
                <p>First Beauty experience software for brands and independent professionals.</p>


                <div class="mb-3">
                    <a href="/account/join.php?type=business" class="btn btn-primary btn-lg">Try it now</a>
                </div>


                <h4>Try it risk free for 30 days!</h4>
                <p>No risk, and no credit card required!</p>
            </div><!-- end content -->
        </div><!-- end user div -->
    </div><!-- end row -->
    ...
    <div class="container">
        <h2 class="text-center">Why My Beautyfill?</h2>


        <div class="row mb-5">
            <div class="col-lg-3 col-md-6">
                <div class="numbered-cards-container">
                    <div class="numbered-cards">
                        <div class="numbered-cards-num">1</div>
                        <p class="strong">Get Online</p>
                        <p>Set up your professional website and let clients know you're available to be booked online. Include your services, business
                            hours and photo gallery.</p>
                    </div><!-- end numbered cards -->
                </div><!-- end container -->
            </div><!-- end col -->
            ...
            <div class="col-lg-3 col-md-6">
                <div class="numbered-cards-container">
                    <div class="numbered-cards">
                        <div class="numbered-cards-num">2</div>
                        <p class="strong">Get Organized</p>
                        <p>Manage your schedule and client notes. Appointment reminders are sent automatically.</p>
                    </div><!-- end numbered cards -->
                </div><!-- end container -->
            </div><!-- end col -->
            ...
            <div class="col-lg-3 col-md-6">
                <div class="numbered-cards-container">
                    <div class="numbered-cards">
                        <div class="numbered-cards-num">3</div>
                        <p class="strong">Get Booked</p>
                        <p>Use your new VIP link to promote yourself online through social media, email marketing or by running a promotion. Make it
                            easy for clients to find and book you.</p>
                    </div><!-- end numbered cards -->
                </div><!-- end container -->
            </div><!-- end col -->
            ...
            <div class="col-lg-3 col-md-6">
                <div class="numbered-cards-container">
                    <div class="numbered-cards">
                        <div class="numbered-cards-num">4</div>
                        <p class="strong">Get Paid</p>
                        <p>Instantly accept credit card payments or set up a no-show late cancellation policy. Get next day payouts directly to your
                            bank account.</p>
                    </div><!-- end numbered cards -->
                </div><!-- end container -->
            </div><!-- end col -->
    ...
    <section class="container join-page-banner mb-5">
        <div class="row align-items-center justify-content-center">
            <div>
                <div class="join-page-banner-price">$30/MO</div>
                <div class="join-page-banner-details">dead simple pricing</div>
            </div>

            <p class="mx-5">
                <a class="btn btn-primary btn-lg" href="/account/join.php?type=business">Try it now</a>
            </p>
