...
<head>
    ...
    <title>Help | My Beautyfill</title>
...
<nav class="navbar navbar-expand-lg sticky-top navbar-light">
    ...
    <h1 class="about-us-h1">Help</h1>
    
        
    <div class="container">
    
    <form method="POST" action="/help.php" class="mb-5">
    <div class="row mb-5">
        <div class="col-md-6">
            <div class="form-group">
                <label for="help-center-name">Your Name</label>
                <input type="text" id="help-center-name" class="form-control" name="help-center-name" value="">
            </div>

            <div class="form-group">
                <label for="help-center-email">Your Email</label>
                <input type="email" id="help-center-email" class="form-control" name="help-center-email" value="">
            </div>

            <div class="form-group">
                <label for="help-center-option">Choose an option:</label>
                <select class="form-control" id="help-center-option" name="help-center-option">
                                            <option>I found a bug!</option>
                                            <option>My appointment disappeared.</option>
                                            <option>New feature request.</option>
                                            <option>Cancel my appointment.</option>
                                            <option>Reset my account.</option>
                                    </select>
            </div><!-- end form group -->
        </div><!-- end col -->

        <div class="col-md-6">
            <label for="help-center-detail">Fill in as much detail as possible:</label>
            <textarea class="form-control" id="help-center-detail" rows="3" name="help-center-detail" style="height: calc(100% - 51px);"></textarea>
        </div>
    </div><!-- end row -->
    
    <div class="text-center"><button class="btn btn-primary" type="submit">Submit Request</button></div>
</form>
