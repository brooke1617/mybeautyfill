...
<head>
    ...
    <title>About | My Beautyfill</title>
...
<nav class="navbar navbar-expand-lg sticky-top navbar-light">
    ...
    <div class="container text-center">
        <h1 class="about-us-h1">MyBeautyFill is the first On Demand Glam Enthusiast Consulting & Delivery company benefiting Domestic Violence Survivors!</h1>

        <p>We’re extending an exclusive BETA Brand Partner Invite for a limited time only to 100 Brands. (Offer ends May 31st, 2019)</p>

        <p class="mb-5">Enjoy one year of MyBeautyFill valued at over $1500 if you join now for the following options:</p>
        ...
        <div class="card-deck mb-3 text-center">
            <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                    <h1 class="card-title pricing-card-title">$175 <small class="text-muted">/ mo</small></h1>
                    <ul class="list-unstyled mt-3 mb-4">
                        <li>One year Beta Brand Badge</li>
                        <li>5 Product listings & 2 variants per product</li>
                        <li>Unlimited Service listings</li>
                        <li>1 Ad on social media per month</li>
                        <li>Yearly Discounted flat rate renewal rate not including App Ads</li>
                    </ul>
                    <a href="/account/join.php?type=business" class="btn btn-lg btn-primary">Get started</a>
                </div>
            </div>
            <div class="card mb-4 box-shadow">
                <div class="card-header">
                    <h4 class="my-0 font-weight-normal">Mogul</h4>
                </div>
                <div class="card-body">
                    <h1 class="card-title pricing-card-title">$325 <small class="text-muted">/ mo</small></h1>
                    <ul class="list-unstyled mt-3 mb-4">
                        <li>One year Beta Brand Badge</li>
                        <li>Unlimited Product & variant listings</li>
                        <li>Delivery option (launching late Summer 2019)</li>
                        <li>Unlimited Services</li>
                        <li>2 Ads per month (1 Social & 1 App Ad)</li>
                        <li>1 event placement per quarter. (MBF does 3 events per month : 12 per quarter)</li>
                        <li>Yearly discounted flat rate renewal option</li>
                        <li></li>
                    </ul>
                    <a href="/account/join.php?type=business" class="btn btn-lg btn-primary">Get started</a>
                </div>
